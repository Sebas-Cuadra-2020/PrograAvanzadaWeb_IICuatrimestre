...
{
    public class RolEmpleadoServices
    {
        public List<Models.RolEmpleado> GetAll()
        {
        ...
        public async Task<List<Models.RolEmpleado>> GetAllAsync()
        {
            List<Models.RolEmpleado> aux = new List<Models.RolEmpleado>();
            using (var cl = new HttpClient())
            {
        ...
        public Models.RolEmpleado GetById(int? id)
        {
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    cl.DefaultRequestHeaders.Clear();
                    cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                    HttpResponseMessage res = await cl.DeleteAsync("api/RolEmpleado/" + id);
        ...
        public bool Updated(int id, Models.RolEmpleado rolEmpleado)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    cl.BaseAddress = new Uri(Program.baseurl);
                    var content = JsonConvert.SerializeObject(rolEmpleado);
                    var buffer = System.Text.Encoding.UTF8.GetBytes(content);
                    var byteContent = new ByteArrayContent(buffer);
                    byteContent.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/json");
                    var postTask = cl.PutAsync("api/RolEmpleado/" + id, byteContent).Result;
        ...
        public bool Create(Models.RolEmpleado rolEmpleado)
        {
            try
            {
                using (var cl = new HttpClient())
