...
namespace FronEnd.API.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdProveedor"] = new SelectList(proveedor.GetAll(), "IdProveedor", "NombreProveedor");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["IdFamiliaProducto"] = new SelectList(familiaP.GetAll(), "IdFamiliaProducto", "NombreFamiliaProducto", producto.IdFamiliaProducto);
            ViewData["IdProveedor"] = new SelectList(proveedor.GetAll(), "IdProveedor", "NombreProveedor", producto.IdProveedor);
            return View(producto);
        }
